...
exports.convert = exports.convertMobile = exports.convertDesktop = exports.downscale = exports.downscaleMobile = exports.downscaleDesktop = exports.sortAll = exports.upscale = exports.upscaleMobile = exports.upscaleDesktop = exports.checkDuplicates = exports.getFinalFolders = exports.getUpscaleFolders = exports.getDungeonFolders = exports.getImaginaryFolders = exports.knownDupesPath = void 0;
const fs = require("fs");
...
const outputFinal = `${utils_1.NASPath}/pictures/wallpapers-upscaled-desktop`;
const outputMobile = `${utils_1.NASPath}/pictures/wallpapers-upscaled-mobile`;
...
exports.knownDupesPath = `${utils_1.NASPath}/pictures/knownDupes.json`;
...
function getImaginaryFolders() {
    const subNames = Object.keys(imaginary_subs_1.subs);
    return subNames.map((subName) => {
        const sub = imaginary_subs_1.subs[subName];
        return sub.folderPath ?? path.join(utils.ImaginaryPath, subName);
    }).sort();
}
exports.getImaginaryFolders = getImaginaryFolders;
function getDungeonFolders() {
    const subNames = Object.keys(dungeon_subs_1.subs);
    return subNames.map((subName) => {
        const sub = dungeon_subs_1.subs[subName];
        return sub.folderPath;
    });
}
exports.getDungeonFolders = getDungeonFolders;
function getUpscaleFolders() {
...
exports.getUpscaleFolders = getUpscaleFolders;
function getFinalFolders() {
    return [outputFinal, outputMobile];
}
exports.getFinalFolders = getFinalFolders;
...
exports.upscaleDesktop = upscaleDesktop;
async function upscaleMobile() {
...
exports.upscaleMobile = upscaleMobile;
function upscale() {
    upscaleDesktop().then(() => {
        utils.logLine();
...
async function sortAll() {
    ...
    const knownDupesRaw = fs.readFileSync(exports.knownDupesPath, "utf8");
...
exports.convertDesktop = convertDesktop;
...
exports.convertMobile = convertMobile;
function convert() {
